...
echo "Давайте поэкспериментируем с приватным свойством 'hidden':\n";
echo "Приватные свойства видны внутри класса, поэтому __get() не используется...\n";
echo $obj->getHidden() . "\n";
echo "Приватные свойства не видны вне класса, поэтому __get() используется...\n";
echo $obj->hidden . "\n";
